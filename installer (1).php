...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210827_projethumanitaire_0a094753723a2e549321_20210827123803_archive.zip';
	const ARCHIVE_SIZE		 = '68744588';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '0a09475-27123803';
    const SECONDARY_PACKAGE_HASH = 'ca70783-27123803';
	const VERSION			 = '1.4.2';
